...
<body>
  <form action="" method="post">
    <div class="container-form">
      ...
      <div class="container">
        <label for="code"><b>Ingrese el c&oacute;digo de activaci&oacute;n.</b></label>
        <input type="text" id="txt_verificar_codigo" name="txt_verificar_codigo" placeholder="C&oacute;digo de activaci&oacute;n" value="<?php if(isset($_POST['txt_verificar_codigo'])){echo $_POST['txt_verificar_codigo'];}?>" autofocus>
...
if (isset($_POST['confirmar'])) {
  ...
  echo "<script>Swal.fire({
    icon: 'warning',
    html: 'Por favor ingrese el c&oacute;digo de activaci&oacute;n.',
    confirmButtonColor: '#3085d6',
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false
  });</script>";
}else /*if (isset($_POST['txt_verificar_codigo']) && isset($_POST['usuario']) && isset($_POST['token']))*/ {
    ...
    echo "<script>Swal.fire({
      ...
      allowOutsideClick: false
        ...
        if (result.isConfirmed) {
          window.location = '".SERVERURL."registro-password';
        }
      });</script>";
