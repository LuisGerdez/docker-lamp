...
// 	$sql="SELECT MAX(trade_id) FROM tbl_trade_in_pronto_pago";
// 	$result= $link->query($sql);
// 	$account=mysqli_fetch_row($result);
// 	$valor= end($account)+1;
// 	//TRAEMOS LOS DATOS DE LA TABLA codigo_validacion 
// 	$otp=rand(1000, 99999999);
// 	var_dump($otp);
// 	die();
// 	$sql = "INSERT INTO tbl_pronto_pago VALUES('".$valor."','".$tradefecha."','".$tradename."','".$trade1."','".$trade2."','".$trade3."','".$tradeserie."','".$tradecuenta."','".$tradebanco."','".$tradenumber."','".$tradepoliza."','".$tradeservicio."','".$otp."')";
