...
<script>
    function validarCodigo() {
            $.ajax({
              type: "POST",
              url: "../controller/verificar_code.php",
    ...
    <div class="modal-content">
      ...
      <div class="panel-parrafo">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
          <img class="cerrar" src="../../recursos/iconos/cerrar-gris.png" alt="Cerrar" title="Cerrar">
        </button>
      </div>
            ...
            <div class="container-validar">
                <div class="validar-panel">
                    ...
                    <div class="panel-input">
                        ...
                        value="<?php if(isset($_POST['verificar_codigo']))
                        {
                          echo $_POST['verificar_codigo'];
                          }?>" 
                        placeholder="C&oacute;digo de activaci&oacute;n" autofocus>
